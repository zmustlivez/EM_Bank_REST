...
<h2>📁 Стартовая структура</h2>
  <p>
    Проектная структура с директориями и <code>README.md</code> файлами уже создана.<br />
    Все реализации нужно добавлять <strong>в соответствующие файлы и папки</strong>.
  </p>
...
<h2>📊 Оценка</h2>
  <ul>
    ...
    <li>Чистота и архитектура кода</li>
    <li>Безопасность</li>
